                ...
                <ul id="menu-list" className="space-y-3">
                    ...
                    <li>
                        <NavLink id="menu-error-400" to="/error-400" className={menuClass}>
                            <MdReportGmailerrorred className="mr-4 text-xl"/>Error 400
                        </NavLink>
                    </li>
                    <li>
                        <NavLink id="menu-error-401" to="/error-401" className={menuClass}>
                            <MdOutlineNoEncryption className="mr-4 text-xl"/>Error 401
                        </NavLink>
                    </li>
                    <li>
                        <NavLink id="menu-error-403" to="/error-403" className={menuClass}>
                            <AiOutlineWarning className="mr-4 text-xl"/>Error 403
                        </NavLink>
                    </li>
                </ul>
            </div>
